...
import math
    ...
    def decode(datagram):
        ...
        if messageHeader[0] == 0 : #Login request dataType
            ...
            fieldsList.append(unpacking.decodeEvents(nbreEvents, datagram[8:]))
            ...
            fieldsList.append(unpacking.decodeRooms(nbreRooms, datagram[8:]))
            ...
            fieldsList.append(unpacking.decodeUsers(nbreUsers, datagram[8:]))
